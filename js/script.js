...
function initTeamPage() {
    ...
    const sections = {
        ...
        crew:     { titleKey: 'team_crew_subtitle', members: ['alairen', 'dekiru', 'dragon', 'galleta', 'koto', 'dezzu', 'loxy', 'lulu', 'nebula', 'papu', 'mcandrea', 'chepescm', 'razielsempai', 'ruto', 'rosy', 'siniz', 'veiga', 'youkai', 'naruhishi', 'riku', 'eli',] }
    };
