...
function initTeamPage() {
    ...
    const sections = {
        ...
        crew:     { titleKey: 'team_crew_subtitle', members: ['alairen', 'dekiru', 'koto', 'loxy', 'lulu', 'nebula', 'papu', 'mcandrea', 'razielsempai', 'veiga', 'youkai', 'naruhishi', 'riku', 'eli', 'draxus', 'may', 'soul'] }
    };
