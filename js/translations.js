const translations = {
    ...
    en: {
        ...
        rule_companion_p1: "<strong>Limits for standard services:</strong> You cannot request two people at once. The limit is 2 services per person per night, with a maximum time of 5 minutes per service.",
        ...
        // -------------------------------------------------------------
        // 9.0  APPLICATION PAGE (application.html)
        // -------------------------------------------------------------
        ...
        form_label_new_role_desc: "If you selected 'New Role', please describe it and its function here:",
    ...
    es: {
        ...
        // -------------------------------------------------------------
        // 2.0  PÁGINA DE INICIO (index.html)
        // -------------------------------------------------------------
        hero_title: "Libra's Club",
        ...
        team_owners_subtitle: "Dueños",
        team_managers_subtitle: "Staff Managers",
        team_crew_subtitle: "Equipo",
        ...
        member_spotify_label: "Ver Playlist en Spotify",
        ...
        // -------------------------------------------------------------
        // 8.0  PÁGINA DE REGLAS (rules.html)
        // -------------------------------------------------------------
        ...
        rule_companion_p1: "<strong>Límites para servicios estándar:</strong> No se puede pedir dos personas a la vez. El límite es de 2 servicios por persona en la noche, con un tiempo máximo de 5 minutos por servicio.",
        ...
        // -------------------------------------------------------------
        // 9.0  PÁGINA DE APLICACIÓN (application.html)
        // -------------------------------------------------------------
        apply_title: "Únete al Equipo",
        form_label_vrc_name: "Link de Perfil de VRChat",
        form_label_discord_name: "Usuario de Discord",
